...
## Patches list
+ alpha (transparency)
+ fullscreen-compilation (i added a few line to fix fakefullscreen issues with chromium based browser. Thanks to NRK)  https://github.com/paniash/dwm/blob/master/patches/dwm-fullscreen-compilation-6.2.diff
